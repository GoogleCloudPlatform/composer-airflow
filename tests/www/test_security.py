...
def test_sync_perm_for_dag_rbac_autoregister_per_folder_roles(security_manager):
    ...
    def _test_role_has_permission():
        ...
        return security_manager.permission_exists_in_one_or_more_roles(
            prefixed_test_dag_id, permissions.ACTION_CAN_READ, [_role.id]
        )
    ...
    security_manager.sync_perm_for_dag(test_dag_id, access_control={})
