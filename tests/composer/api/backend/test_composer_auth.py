...
from airflow.configuration import WEBSERVER_CONFIG, write_default_airflow_configuration_if_needed, \
    write_webserver_configuration_if_needed, initialize_config
...
class TestComposerAuth:
    ...
    def setup_class(cls):
        ...
        with conf_vars(
            ...
            cls.app.config["AUTH_ROLE_PUBLIC"] = None
    ...
    def test_authentication_success(self, _decode_iap_jwt_mock):
        ...
        config_response = self.test_client.get(
            "/api/v1/config", headers={"X-Goog-IAP-JWT-Assertion": "jwt-test"}
        )
        ...
        # "User" role doesn't have access to config endpoint.
