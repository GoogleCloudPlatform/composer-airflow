...
from airflow.composer.pre_commit_config import _create_composer_config, create_composer_config_file
...
class TestPreCommitConfig:
    ...
    def test_create_composer_config_file(self):
        ...
        with patch.object(
            pre_commit_config, "__file__", os.path.join(tmp_dir, "airflow/composer/pre_commit_config.py")
        ):
