...
class TestLoader(unittest.TestCase):
    ...
    def test_get_connection_form_widgets(self):
        ...
        datadog_api_host_widget = connection_form_widgets["extra__datadog__api_host"]
        self.assertEqual(datadog_api_host_widget.hook_class_name, "DatadogHook")
        self.assertEqual(datadog_api_host_widget.package_name, "apache-airflow-providers-datadog")
        self.assertEqual(datadog_api_host_widget.field.args, ("API endpoint",))
        self.assertIsInstance(datadog_api_host_widget.field.kwargs["widget"], BS3TextFieldWidget)
