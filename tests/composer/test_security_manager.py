...
from airflow.composer.security_manager import _get_first_and_last_name, ComposerAirflowSecurityManager
        ...
        mock_dag_bag = mock.MagicMock(
            dags=mock.MagicMock(
                values=mock.MagicMock(
                    return_value=[
                        mock.MagicMock(parent_dag=mock.MagicMock(dag_id=test_dag_id_0), access_control=test_access_control_0),
                        mock.MagicMock(parent_dag=None, dag_id=test_dag_id_1, access_control=test_access_control_1),
                    ]
                )
            )
        )
