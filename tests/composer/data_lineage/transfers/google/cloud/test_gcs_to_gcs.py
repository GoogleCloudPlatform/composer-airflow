...
class TestGCSToGCSOperator:
    @pytest.mark.parametrize(
        "test_id, source_object, destination_bucket, destination_object, expected_inlets, expected_outlets",
        [
            (
    ...
    @pytest.mark.parametrize(
        "test_id, source_objects, destination_bucket, destination_object, expected_inlets, expected_outlets",
        [
            (
