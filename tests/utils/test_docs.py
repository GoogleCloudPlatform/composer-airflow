...
class TestGetDocsUrl:
    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                ...
                "2023.4.13+composer",
                "https://github.com/GoogleCloudPlatform/composer-airflow/blob/providers-google-2023.4.13+composer/airflow/providers/google/CHANGELOG.rst",
            ),
            (
                "apache-airflow-providers-google",
                "8.9.0",
    ...
    @mock.patch("airflow.utils.docs.metadata.metadata", autospec=True)
