...
class TestStuckTriggerRunner:
    ...
    def test_non_stuck_triggers_loop(self, caplog):
        try:
            ...
            airflow.jobs.triggerer_job_runner.TRIGGERS_ASYNC_LOOP_BLOCKED_TIMEOUT = 5
    ...
    @patch(
        "airflow.jobs.triggerer_job_runner.TriggerRunner.run",
        side_effect=lambda: time.sleep(50)
    )
