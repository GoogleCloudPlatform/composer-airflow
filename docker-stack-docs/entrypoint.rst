...
.. code-block:: bash
  ...
  docker run -it apache/airflow:3.2.1-python3.10 bash -c "ls -la"
  total 16
...
.. code-block:: bash
  ...
  > docker run -it apache/airflow:3.2.1-python3.10 python -c "print('test')"
  test
...
.. code-block:: bash
   ...
   docker run -it apache/airflow:3.2.1-python3.10 airflow webserver

If there are any other arguments - they are simply passed to the "airflow" command

.. code-block:: bash

  > docker run -it apache/airflow:3.2.1-python3.10 help
...
.. code-block:: bash
  ...
  docker run -it -p 8080:8080 \
    ...
    --env "_AIRFLOW_WWW_USER_PASSWORD=admin" \
      apache/airflow:3.2.1-python3.10 webserver
