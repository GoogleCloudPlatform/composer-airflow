...
DEVEL_EXTRAS: dict[str, list[str]] = {
    ...
    "devel-devscripts": [
        ...
        # Example failure without it: https://github.com/apache/airflow/actions/runs/17770084165/joInternal bug?pr=55725
...
COMPOSER_DEPENDENCIES = [
    ...
    # TODO: Internal bug - Remove <=10.14.0 after freeze
    "apache-airflow-providers-cncf-kubernetes!=10.10.0,<=10.14.0",
    "apache-airflow-providers-dbt-cloud",
    # TODO: Internal bug - Remove <=20.0.0 after freeze
