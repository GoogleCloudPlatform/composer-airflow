...
in the `documentation <https://airflow.apache.org/docs/apache-airflow-providers-ydInternal bug.3.1/>`_.
...
.. code-block:: bash
    ...
    pip install apache-airflow-providers-ydb[common.compat]
...
`changelog <https://airflow.apache.org/docs/apache-airflow-providers-ydInternal bug.3.1/changelog.html>`_.
