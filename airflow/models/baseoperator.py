        ...
        while task_ids_to_trace:
            ...
            for task_id in task_ids_to_trace:
                if task_id in found_descendants:
                    continue
                task_ids_to_trace_next.update(self._dag.task_dict[task_id].get_direct_relative_ids(upstream))
        ...
        *,
        ...
        if get_composer_version() is not None and not is_triggerer_enabled():
            ...
            raise AirflowException(
                ...
                "See https://cloud.google.com/composer/docs/composer-2/use-deferrable-operators for more details."
            )
