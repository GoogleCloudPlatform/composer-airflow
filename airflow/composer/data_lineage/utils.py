...
def generate_uuid_from_string(s: str) -> str:
    """Return string representation of UUID generated from given string."""
...
def get_process_id(environment_name: str, dag_id: str, task_id: str) -> str:
    """
    Return lineage process id generated from given parameters.
...
def get_run_id(task_instance_run_id: str) -> str:
    """
    Return lineage run id generated from given parameter.
...
def exclude_outlet(inlets: list[T], outlet: T) -> list[T]:
    """
    Exclude outlet from the given list of inlets.
...
def parsed_sql_statements(sql: str) -> list[Statement]:
    """
    Parse SQL query into a list of Statements.
