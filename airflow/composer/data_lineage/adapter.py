...
import re2
from google.cloud.datacatalog_lineage_v1 import EntityReference, EventLink, LineageEvent, Origin, Process, Run
...
class ComposerDataLineageAdapter:
    ...
    def get_lineage_events_bundle_on_task_completed(
        ...
        """Return Data Lineage events bundle for completed task."""
    ...
    def _construct_process(self, task: BaseOperator | MappedOperator) -> Process:
        """Return Process generated based on Airflow task."""
    ...
    def _construct_run(self, task_instance: TaskInstance, process_name: str) -> Run:
        """Return Run generated based on Airflow task instance."""
    ...
    def _construct_lineage_events(self, inlets: list, outlets: list) -> list[LineageEvent]:
        """
        Return Data Lineage events generated based on Airflow inlets/outlets.
    ...
    def _get_fqn_suffix(self, segments: list[str]) -> str:
        """Escape segments if necessary and concatenates them with '.'."""
    ...
    def _get_entity_reference(self, entity: Any) -> EntityReference | None:
        """
        Return Data Lineage entity reference for given Airflow entity (None if entity is unknown).
    ...
    def _sanitize_display_name(self, display_name: str) -> str:
        """
        Sanitize display_name for Process and Run.
