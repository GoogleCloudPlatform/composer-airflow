...
def compile_table_data(model_class, age_column, extra_data=None):
    """Act as a helper function to create a table entry."""
...
def tables_to_trim():
    """
    Return a list of tables with primary keys for them and any additional information.
    ...
    tables = [
        ...
        compile_table_data(ParseImportError, ParseImportError.timestamp),
        compile_table_data(
            XCom,
            XCom.execution_date,
