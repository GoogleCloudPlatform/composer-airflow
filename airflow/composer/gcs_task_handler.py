...
# NOTE: We keep this separately to avoid overriding our
# custom patches by users installing providers packages
...
class GCSTaskHandler(FileTaskHandler, LoggingMixin):
    ...
    It handles and reads task instance logs. It extends airflow FileTaskHandler and
    ...
    def __init__(
        ...
        *,
        ...
        gcp_scopes: Collection[str] | None = _DEFAULT_SCOPESS,  # pylint: disable=unsubscriptable-object
    ...
    def _read(self, ti, try_number, metadata=None):
        ...
        try:
            ...
            log = (
                f"*** Log file is not found: {remote_loc}.\n*** The task might not have "
    ...
    def gcs_write(self, log, remote_log_location):
        """
        Write the log to the remote_log_location.

        Fails silently if no log was created.
