...
You can find the following images there (Assuming Airflow version `2.10.3`):
...
* `apache/airflow:2.10.3` - the versioned Airflow image with default Python version (3.8 currently)
* `apache/airflow:2.10.3-pythonX.Y` - the versioned Airflow image with specific Python version
...
* `apache/airflow:slim-2.10.3`           - the versioned Airflow image with default Python version (3.8 currently)
* `apache/airflow:slim-2.10.3-pythonX.Y` - the versioned Airflow image with specific Python version
