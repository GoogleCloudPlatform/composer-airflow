...
You can find the following images there (Assuming Airflow version `2.4.0b1`):
...
* `apache/airflow:2.4.0b1` - the versioned Airflow image with default Python version (3.7 currently)
* `apache/airflow:2.4.0b1-pythonX.Y` - the versioned Airflow image with specific Python version
...
* `apache/airflow:slim-2.4.0b1`           - the versioned Airflow image with default Python version (3.7 currently)
* `apache/airflow:slim-2.4.0b1-pythonX.Y` - the versioned Airflow image with specific Python version
