...
def _make_airflow_structlogger(min_level):
    # This uses https://github.com/hynek/structlog/bloInternal bugf0cc42d/src/structlog/_native.py#L126
    # as inspiration
    ...
    def make_method(
        ...
        def meth(self: Any, event: str, *args: Any, **kw: Any) -> Any:
            ...
            # See for reason https://github.com/python/cpython/bloInternal bug.13/Lib/logging/__init__.py#L307-L326
