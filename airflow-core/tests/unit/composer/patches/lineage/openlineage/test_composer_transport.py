...
from airflow.composer.patches.lineage.openlineage.composer_transport import (
    ComposerTransport,
    ComposerTransportConfig,
)
from airflow.composer.patches.lineage.openlineage.facets import ComposerJobFacet, ComposerRunFacet, GcpOrigin
...
class TestComposerTransport:
    ...
    def test_emit(self, event, expected_metadata):
        ...
        with (
            mock.patch(
                "airflow.composer.patches.lineage.openlineage.composer_transport.SyncLineageClient",
                autospec=True,
            ) as mock_sync_lineage_client,
            mock.patch(
                "airflow.composer.patches.lineage.openlineage.composer_transport.get_redacted_event",
                autospec=True,
