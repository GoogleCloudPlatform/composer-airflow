...
When the token expires, the `JWTRefreshMiddleware <https://github.com/apache/airflow/bloInternal bug.1.5/airflow-core/src/airflow/api_fastapi/auth/middlewares/refresh_token.py>`_ middleware calls the auth manager's ``refresh_user`` method to obtain a new token.
...
`KeycloakAuthManager::refresh_user <https://github.com/apache/airflow/bloInternal bug.1.5/providers/keycloak/src/airflow/providers/keycloak/auth_manager/keycloak_auth_manager.py#L113-L121>`_
...
`KeycloakAuthManagerUser(BaseUser) <https://github.com/apache/airflow/bloInternal bug.1.5/providers/keycloak/src/airflow/providers/keycloak/auth_manager/user.pys>`_.
