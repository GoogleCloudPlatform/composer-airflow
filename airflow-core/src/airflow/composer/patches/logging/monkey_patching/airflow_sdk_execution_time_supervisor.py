...
from airflow.composer.patches.logging.supervisor_logs import get_task_logs_contextvars
from airflow.sdk.execution_time import supervisor


def patch():
    supervisor.supervise_task = _composer_supervisor_supervise_task(supervisor.supervise_task)


def _composer_supervisor_supervise_task(f):
    @functools.wraps(f)
